...
VisualizingImageType::Pointer Vertebra::getMaskFromImageInformation(
...
VisualizingImageType::Pointer Vertebra::getVisualizationMask()
{
    return getMaskFromImageInformation(
        logic.visualizing->GetLargestPossibleRegion(),
        logic.visualizing->GetSpacing(),
        logic.visualizing->GetOrigin(),
        logic.visualizing->GetDirection());
}

VisualizingImageType::Pointer Vertebra::getOriginalMask()
{
    return getMaskFromImageInformation(
        logic.current->GetLargestPossibleRegion(),
        logic.current->GetSpacing(),
        logic.current->GetOrigin(),
        logic.current->GetDirection());
}
...
{
    VisualizingImageType::Pointer thisMask=getVisualizationMask();
    maskLock.lock();
